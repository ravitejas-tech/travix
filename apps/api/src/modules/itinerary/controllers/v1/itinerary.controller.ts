...
import { ActivityIdParam, AddActivityPayload, DayIdParam, RegenerateDayPayload, TripIdParam } from '../../dtos/payloads'
...
export class V1ItineraryController {
    ...
    async regenerateDay(
        ...
        return this.commandBus.execute(
            Builder(RegenerateDayCommand, { userId, tripId, dayId, instructions: body.instructions }).build(),
        )
    }
    ...
    async addActivity(
        ...
        return this.commandBus.execute(Builder(AddActivityCommand, { userId, tripId, dayId, payload: body }).build())
    }
    ...
    async removeActivity(
        ...
        await this.commandBus.execute(Builder(RemoveActivityCommand, { userId, tripId, dayId, activityId }).build())
    }
}
