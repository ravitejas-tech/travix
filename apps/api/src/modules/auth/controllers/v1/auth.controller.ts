...
export class V1AuthController {
  ...
  async register(
    body: Static<typeof RegisterPayload>,
  ): Promise<Static<typeof AuthBaseResponse>> {
    return this.commandBus.execute(
      Builder(RegisterUserCommand, { payload: body }).build(),
    );
  }
  ...
  async login(
    ...
    return this.commandBus.execute(
      Builder(LoginCommand, { payload: body }).build(),
    );
  }
  ...
  async refresh(
    body: Static<typeof RefreshTokenPayload>,
  ): Promise<Static<typeof AuthBaseResponse>> {
    return this.commandBus.execute(
      Builder(RefreshTokenCommand, { refreshToken: body.refreshToken }).build(),
    );
  }
  ...
  ): Promise<Static<typeof AuthUserResponse>> {
