        ...
        <footer className="bg-primary-dark text-white">
            <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 sm:px-10 md:grid-cols-[1.5fr_repeat(3,1fr)]">
                <div className="flex flex-col gap-4">
                    <img src="/logo.png" alt="Travix" className="h-14 w-14 object-contain" />
                    <p className="max-w-xs text-sm text-white/60">AI-crafted trips, personal to the way you travel.</p>
                </div>
