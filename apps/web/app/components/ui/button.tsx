...
const STYLES: Record<Variant, string> = {
    primary: 'bg-white text-primary shadow-lg shadow-black/20 hover:bg-gray-100',
    ghost: 'border border-white/30 bg-white/10 text-white backdrop-blur hover:bg-white/20',
    solid: 'bg-primary text-white shadow-lg shadow-primary/30 hover:bg-primary-dark',
}
