            ...
            <Link to={`/dashboard/trips/${trip.id}`} className="block">
                <div className={`relative h-28 bg-gradient-to-br ${GRADIENTS[trip.budgetType]} p-4`}>
                    ...
                    <div className="absolute bottom-3 left-4 text-white">
                        ...
                        <h3 className="text-xl font-bold leading-tight drop-shadow-sm">{trip.destination.cityName}</h3>
                    </div>
                </div>
                ...
                <div className="p-4">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm font-semibold text-primary">{formatMoney(trip.total)}</span>
                    </div>
                    {tags.length > 0 && (
