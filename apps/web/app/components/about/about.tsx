        ...
        <section id="about" className="bg-primary/[0.03] py-24">
            <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 sm:px-10 lg:grid-cols-2">
                ...
                <Reveal delay={0.1} className="flex flex-col gap-6">
                    <span className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">Why Travix</span>
                    <h2 className="text-3xl font-semibold leading-tight text-primary sm:text-4xl">
                        The planning, handled. The journey, yours.
                    </h2>
                    <p className="text-muted">
                        Travix learns your budget, your dates and the things you enjoy, then turns them into a trip you
                        can reshape whenever the mood strikes. Every plan stays private to you, yours to tweak,
                        regenerate or follow exactly as it is.
                    </p>
                    <StatGrid />
                    <div>
