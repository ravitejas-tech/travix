...
export const PRICING_PLANS: PricingPlan[] = [
    ...
    },
    {
        ...
        cta: 'Go Voyager',
        featured: true,
        features: ['Unlimited trips', 'Regenerate any day', 'Hotel recommendations', 'Priority AI planning'],
    },
    {
        name: 'Pioneer',
        price: '$29',
        ...
        cta: 'Go Pioneer',
        features: ['Everything in Voyager', 'Collaborative trips', 'Export to PDF', 'Early access features'],
    },
]
