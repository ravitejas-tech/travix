...
export type ActivityTypeValue = 'food' | 'culture' | 'adventure' | 'shopping' | 'sightseeing' | 'other'
export type TripStatus = 'draft' | 'generating' | 'active' | 'archived'
export type HotelCategory = 'budget' | 'mid_range' | 'luxury'

export const ACTIVITY_TYPE_META: Record<ActivityTypeValue, { label: string; icon: LucideIcon }> = {
...
export const HOTEL_CATEGORY_META: Record<HotelCategory, { label: string; className: string }> = {
