...
export default function DashboardHome() {
  ...
  if (isError)
    return (
      <ErrorScreen message="We couldn't load your dashboard." onRetry={refetch} />
    );
      ...
      {trips.length === 0 ? (
        <div className="space-y-6">
          <div className="rounded-2xl bg-blue-50/40 border border-blue-100/50 p-4 text-sm text-primary flex items-start gap-2.5">
            ...
            <span>Create a fully customized daily plan, hotel options, and budget breakdown in under 30 seconds. Try it below!</span>
          </div>
