...
export const useLogin = createMutation<V1AuthControllerLoginResponse, V1AuthControllerLoginBody, Error>({
...
export const useRegister = createMutation<V1AuthControllerRegisterResponse, V1AuthControllerRegisterBody, Error>({
