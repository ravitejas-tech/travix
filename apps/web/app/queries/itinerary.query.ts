...
>({
  ...
  mutationFn: ({ tripId, dayId, instructions }) =>
    client.v1
      .regenerateV1ItineraryDay(dayId, tripId, { instructions })
      .then((res) => res.data),
})
...
>({
  ...
  mutationFn: ({ tripId, dayId, ...body }) =>
    client.v1
      .addV1ItineraryActivity(dayId, tripId, body)
      .then((res) => res.data),
})

export const useRemoveActivity = createMutation<
  void,
...
>({
  ...
  mutationFn: ({ tripId, dayId, activityId }) =>
    client.v1
      .removeV1ItineraryActivity(activityId, dayId, tripId)
      .then((res) => res.data),
})
