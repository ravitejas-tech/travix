...
> extends HttpClient<SecurityDataType> {
  v1 = {
     ...
     */
    registerV1Auth: (
      data: V1AuthControllerRegisterBody,
     ...
     */
    loginV1Auth: (
      data: V1AuthControllerLoginBody,
      params: RequestParams = {},
    ) =>
     ...
     */
    refreshV1Auth: (
      data: V1AuthControllerRefreshBody,
      params: RequestParams = {},
    ) =>
     ...
     */
    createV1Trips: (
      data: V1TripsControllerCreateBody,
      params: RequestParams = {},
    ) =>
