...
export class addUserLocation1782049892869 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE \`trips\` ADD CONSTRAINT \`FK_8534a5e8426afe4a77593d7ad08\` FOREIGN KEY (\`userLocationId\`) REFERENCES \`cities\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
        )
    }
